    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialPost", x => new { x.RelatedMaterialsId, x.RelatedPostsId });
                    table.ForeignKey(
                        name: "FK_MaterialPost_Materials_RelatedMaterialsId",
                        column: x => x.RelatedMaterialsId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialPost_Posts_RelatedPostsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialPost_RelatedPostsId",
                table: "MaterialPost",
